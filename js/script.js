...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const content = {
        en: {
            ...
            "hero-desc": "Passionate about Cloud, DevOps, Telecom, and Simulation technologies.\nReady to build the future of connected systems.",
            ...
            "about-interests-list": "Cloud Computing, DevOps, Telecom, Network Simulation, and Software Development.",
            ...
            "skills-embedded": "⚙️ Embedded & IoT",
            "skills-monitoring": "🔍 Monitoring & Observability",
            "learning-title": "🚀 Currently Exploring",
            ...
            "proj-hourlog-desc": "A full-stack time tracking web application that allows employees to log working hours and enables admins to monitor productivity, manage shift timings, and generate reports. Includes role-based authentication, admin dashboard, and secure server-side data fetching.",
            "skills-frontend": "🎨 Frontend",
            "skills-backend": "🖥️ Backend / Database",
            "skills-auth": "🔐 Authentication & Security",
        ...
        sv: {
            ...
            "hero-desc": "Engagerad inom molnteknik, DevOps, telekommunikation och simuleringslösningar.\nRedo att bidra till framtidens uppkopplade system.",
            ...
            "about-interests-list": "Molntjänster, DevOps, telekommunikation, nätverkssimulering och mjukvaruutveckling.",
            ...
            "skills-embedded": "⚙️ Inbyggda system & IoT",
            "skills-monitoring": "🔍 Övervakning & Observerbarhet",
            "learning-title": "🚀 Lär mig för närvarande",
            ...
            "proj-3-desc": "Utvecklade en hjälpmedelsenhet för att stödja personer med synnedsättning att navigera.",
            "proj-hourlog-desc": "En fullstack-applikation för tidsregistrering som gör det möjligt för anställda att logga arbetstimmar och administratörer att övervaka produktivitet, hantera arbetspass och generera rapporter. Inkluderar rollbaserad autentisering, adminpanel och säker server-side datahämtning.",
            "skills-frontend": "🎨 Frontend",
            "skills-backend": "🖥️ Backend / Databas",
            "skills-auth": "🔐 Autentisering & Säkerhet",
            "skills-deployment": "🚀 Driftsättning",
